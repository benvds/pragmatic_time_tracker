...
describe("ITimeEntryService Contract Tests", () => {
    ...
    describe("create method", () => {
        ...
        it("should accept CreateTimeEntryRequest and return ServiceResponse<TimeEntry>", async () => {
            ...
            await expect(service.create(request)).rejects.toThrow(
                "TimeEntryService.create not implemented",
            );
        });
    });
    ...
    describe("getAll method", () => {
        ...
        it("should return ServiceResponse<TimeEntry[]>", async () => {
            ...
            await expect(service.getAll()).rejects.toThrow(
                "TimeEntryService.getAll not implemented",
            );
        });
    });
    ...
    describe("getByDate method", () => {
        ...
        it("should accept date string and return ServiceResponse<TimeEntry | null>", async () => {
            ...
            // This should fail until implementation exists (TDD RED phase)
            await expect(service.getByDate(date)).rejects.toThrow(
                "TimeEntryService.getByDate not implemented",
            );
        });
    });
    ...
    describe("getForMonth method", () => {
        ...
        it("should accept year and month numbers and return ServiceResponse<TimeEntry[]>", async () => {
            ...
            // This should fail until implementation exists (TDD RED phase)
            await expect(service.getForMonth(year, month)).rejects.toThrow(
                "TimeEntryService.getForMonth not implemented",
            );
        });
    });
    ...
    describe("update method", () => {
        ...
        it("should accept id string and UpdateTimeEntryRequest and return ServiceResponse<TimeEntry>", async () => {
            ...
            await expect(service.update(id, updates)).rejects.toThrow(
                "TimeEntryService.update not implemented",
            );
        });
    });
    ...
    describe("delete method", () => {
        ...
        it("should accept id string and return ServiceResponse<boolean>", async () => {
            ...
            await expect(service.delete(id)).rejects.toThrow(
                "TimeEntryService.delete not implemented",
            );
        });
    });
    ...
    describe("existsForDate method", () => {
        ...
        it("should accept date string and return ServiceResponse<boolean>", async () => {
            ...
            // This should fail until implementation exists (TDD RED phase)
            await expect(service.existsForDate(date)).rejects.toThrow(
                "TimeEntryService.existsForDate not implemented",
            );
        });
    });
    ...
    describe("method return types", () => {
        it("should return promises for all async methods", async () => {
            ...
            // Check that methods return promises and properly handle expected rejections
            await expect(service.create(request)).rejects.toThrow(
                "TimeEntryService.create not implemented",
            );
            await expect(service.getAll()).rejects.toThrow(
            ...
            await expect(service.getByDate("2025-09-14")).rejects.toThrow(
                "TimeEntryService.getByDate not implemented",
            );
            await expect(service.getForMonth(2025, 9)).rejects.toThrow(
                "TimeEntryService.getForMonth not implemented",
            );
            ...
            await expect(service.existsForDate("2025-09-14")).rejects.toThrow(
                "TimeEntryService.existsForDate not implemented",
            );
        });
    });
