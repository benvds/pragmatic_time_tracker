...
import type { Field, OkField, ErrorField } from "../util";
...
describe("FieldError", () => {
    ...
    describe("different field types", () => {
        ...
        it("should work with boolean field errors", () => {
            const field: ErrorField<boolean> = {
                value: false,
        ...
        it("should work with object field errors", () => {
            const field: ErrorField<{ name: string }> = {
                value: undefined,
